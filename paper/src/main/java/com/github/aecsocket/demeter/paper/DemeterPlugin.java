...
import com.github.aecsocket.demeter.paper.util.GrassColors;
import com.github.aecsocket.demeter.paper.util.ImageColors;
...
import com.github.aecsocket.minecommons.core.serializers.ByKeySerializer;
...
public class DemeterPlugin extends BasePlugin<DemeterPlugin> {
    ...
    public void onEnable() {
        ...
        protocol.manager().addPacketListener(new PacketAdapter(this,
                PacketType.Play.Server.MAP_CHUNK, PacketType.Play.Server.LIGHT_UPDATE) {
            @Override
