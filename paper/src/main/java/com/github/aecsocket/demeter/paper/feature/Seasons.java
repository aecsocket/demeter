...
import com.github.aecsocket.minecommons.paper.MinecommonsPlugin;
import com.github.aecsocket.minecommons.paper.biome.BiomeInjector;
import com.github.aecsocket.minecommons.paper.biome.PaperBiomeData;
import com.github.aecsocket.minecommons.paper.biome.PaperBiomeEffects;
...
public class Seasons extends Feature<Seasons.Config> {
    ...
    static Key key = Key.key("minecraft", "forest");
    ...
    public void mapChunk(PacketEvent event) {
        ...
        config.worlds.get(world).ifPresent(worldConfig -> {
            ...
            // BENCHMARKED: the remapper here is quite fast, so to improve performance, the remap process
